...
async function startVoiceSession() {
  ...
  } catch (err) { console.error('Voice session error:', err); const message = err instanceof Error ? err.message : String(err); statusEl.textContent = `Fout: ${message}`; stopVoiceSession(); }
}
